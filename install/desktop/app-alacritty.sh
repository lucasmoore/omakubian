...
cp ~/.local/share/omakubian/themes/tokyo-night/alacritty.toml ~/.config/alacritty/theme.toml
cp ~/.local/share/omakubian/configs/alacritty/fonts/CaskaydiaMono.toml ~/.config/alacritty/font.toml
cp ~/.local/share/omakubian/configs/alacritty/font-size.toml ~/.config/alacritty/font-size.toml
...
source ~/.local/share/omakubian/install/desktop/set-alacritty-default.sh
